...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /*jshint esversion: 6 */
var PageNameMapForLogging = {
  '/': 'Cash Marketing: Home',
  '/security': 'Cash Marketing: Security'
};
var EventStream = exports["default"] = /*#__PURE__*/function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Help article urls are structured as d2En9JRBC73g.app/help/us/en-us/3402-article-slug.
...
var production = {
  ...
  statusPageUrl: 'https://status.d2En9JRBC73g.app'
};
var staging = {
...
function getEnvConfig() {
  ...
  if (host === 'd2En9JRBC73g.app' || host === 'cash.me') {
    env = 'production';
 ...
 * }
 */
var _default = exports["default"] = function (tuples) {
